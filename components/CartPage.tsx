  ...
  return (
    <div className="w-full py-10">
      <div className="w-full flex gap-10">
          ...
          <div>
            ...
            <div className="w-full p-5 border-[1px] border-zinc-400 rounded-md flex flex-col gap-4">
              ...
              <div className="flex gap-2">
                <button
                  className="px-2 py-[1px] text-[#004f9a] text-sm border-[1px]
                border-[#004f9a] rounded-sm"
                >
                  Best seller
                </button>
                <button
                  className="px-2 py-[1px] text-red-600 text-sm border-[1px]
                border-red-600 rounded-sm"
                >
                  Rollback
                </button>
              </div>
              ...
              <div>
                {productData.map((item: StoreProduct) => (
                  <div
                    key={item._id}
                    className="flex items-center justify-between gap-4 border-b-[1px]
                    ...
                    <div className="w-3/4 flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-zinc-500 flex items-center gap-1">
                          <span
                            className="bg-blue rounded-full text-white text-xs w-4 h-4
                        ...
                        <div className="mt-2 flex items-center gap-6">
                          <button
                            ...
                            className="text-sm underline underline-offset-2 decoration-[1px]
                            text-zinc-600 hover:no-underline hover:text-blue duration-300"
                          >
                            Remove
                          </button>
                          <div
                            className="w-28 h-9 border border-zinc-400 rounded-full
                        text-base font-semibold text-black flex items-center justify-between px-3"
                          >
                            <button
                              onClick={() =>
                                dispatch(
                              ...
                              className="text-base w-5 -5 text-zinc-600 hover:bg-[#74767c]
                          hover:text-white rounded-full flex items-center justify-center cursor-pointer
                          duration-200"
                            >
                              <HiMinusSmall />
                            </button>
              ...
              <button
                ...
                className="w-44 bg-red-500 text-white h-10 rounded-full text-base
        ...
        <div
          className="w-1/3 p-4 mt-24 h-[500px] border-[1px] border-zinc-400 rounded-md
        ...
        >
          <div className="w-full flex flex-col gap-4 border-b-[1px] border-b-zinc-200 pb-4">
            {userInfo ? (
              ...
              <button
              className="bg-blue bg-opacity-50 cursor-not-allowed w-full text-white h-10 rounded-full font-semibold duration-300">
                Continue to checkout
              </button>
            )}
            {!userInfo && (
            ...
            {warningMsg && (
              <div
                className="bg-[#002d58] text-white p-2 rounded-lg flex items-center
